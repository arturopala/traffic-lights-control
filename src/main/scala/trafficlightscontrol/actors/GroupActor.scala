...
object GroupActor {
  def props(id: Id, memberProps: Iterable[Props], configuration: Configuration): Props =
...
/**
  ...
  */
class GroupActor(val id: Id, val memberProps: Iterable[Props], val configuration: Configuration)
