...
trait TrafficSystemTestKit {
  ...
  object TestLight {
    def apply(id: String, initialState: LightState = RedLight, configuration: Configuration = config)(
  ...
  object TestSequence {
    def apply(id: String, lights: Seq[LightState], configuration: Configuration = config)(
      implicit system: ActorSystem) = {
